...
public class TodoService {
	...
	public List<TodoListDto> getTodoLists() {
		return StreamSupport.stream(todoRepository.findAll().spliterator(), false).map(todoListConverter::convert)
				.collect(Collectors.toList());
	}

	/*
	 * public List<TodoListDto> getTodoLists() { return todoRepository.findAll(); }
	 */
	
	/*
	 * public List<TodoList> getListsTest() { return todoRepository.findAll(); }
	 */
