...
-- 1st "to do" list
INSERT INTO TODO_LIST (todo_list_id,name) VALUES (1, 'Languages to learn TEST');

-- 2nd "to do" list
INSERT INTO TODO_LIST (todo_list_id,name) VALUES (2, 'Languagestocontinuelearning');
...
INSERT INTO TODO_ITEM (todo_item_id, item, complete, todo_list_id) VALUES (1, 'Kotlin Testimg prathap', FALSE, 1);
